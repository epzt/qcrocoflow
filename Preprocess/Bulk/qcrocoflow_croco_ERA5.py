...
#
#  This script use the CDS Python API[*] to connect and download specific ERA5
...
class qcrocoflow_croco_ERA5():

    def __init__(self, _parent=None):
        self.mainApp = _parent

    def addmonths4date(self, date, addmonths):
    ...
    @classmethod
    def ERA5_request_script(self, title, lon_min, lon_max, lat_min, lat_max, directory, Ymin, Ymax, Mmin, Mmax):
        ...
        for j in range(len_monthly_dates):
            ...
            # ---------------------------------------------------------------------
            monthly_date = self.addmonths4date(monthly_date, 1)
        # !/usr/bin/env python
        #
        # ERA5_convert.py
        #
    ...
    @classmethod
    def interp_ERA5(self, ATMO_dir, Y, M, nc_blk, angle, tlen):
